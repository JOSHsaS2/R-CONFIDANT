...
//CONFIDANT: SET CALLBACK FOR REGISTER OUTBOUND PACKETS
    void setCallbackForRegister(Callback<void, Ptr<const Packet>, Address, Ipv4Address, Ipv4Address> cb)
    {
        callbackForRegister = cb;
    }
...
//CONFIDANT: CALLBACK FOR REGISTER OUTBOUND PACKETS FROM MONITOR
    Callback<void, Ptr<const Packet>, Address, Ipv4Address, Ipv4Address> callbackForRegister;
