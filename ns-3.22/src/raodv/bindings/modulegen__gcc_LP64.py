...
def module_init():
    root_module = Module('ns.raodv', cpp_namespace='::ns3')
    return root_module
...
def register_types(module):
    ...
    ## raodv-helper.h (module 'raodv'): ns3::RaodvHelper [class]
    module.add_class('RaodvHelper', parent=root_module['ns3::Ipv4RoutingHelper'])
    ...
    ## Register a nested module for the namespace raodv
    
    nested_module = module.add_cpp_namespace('raodv')
    register_types_ns3_raodv(nested_module)
...
def register_types_ns3_raodv(module):
    root_module = module.get_root()
    
    ## raodv-packet.h (module 'raodv'): ns3::raodv::MessageType [enumeration]
    module.add_enum('MessageType', ['RAODVTYPE_RREQ', 'RAODVTYPE_RREP', 'RAODVTYPE_RERR', 'RAODVTYPE_RREP_ACK'])
    ## raodv-rtable.h (module 'raodv'): ns3::raodv::RouteFlags [enumeration]
    module.add_enum('RouteFlags', ['VALID', 'INVALID', 'IN_SEARCH'])
    ## raodv-dpd.h (module 'raodv'): ns3::raodv::DuplicatePacketDetection [class]
    module.add_class('DuplicatePacketDetection')
    ## raodv-id-cache.h (module 'raodv'): ns3::raodv::IdCache [class]
    module.add_class('IdCache')
    ## raodv-neighbor.h (module 'raodv'): ns3::raodv::Neighbors [class]
    module.add_class('Neighbors')
    ## raodv-neighbor.h (module 'raodv'): ns3::raodv::Neighbors::Neighbor [struct]
    module.add_class('Neighbor', outer_class=root_module['ns3::raodv::Neighbors'])
    ## raodv-rqueue.h (module 'raodv'): ns3::raodv::QueueEntry [class]
    module.add_class('QueueEntry')
    ## raodv-rqueue.h (module 'raodv'): ns3::raodv::RequestQueue [class]
    module.add_class('RequestQueue')
    ## raodv-packet.h (module 'raodv'): ns3::raodv::RerrHeader [class]
    module.add_class('RerrHeader', parent=root_module['ns3::Header'])
    ## raodv-routing-protocol.h (module 'raodv'): ns3::raodv::RoutingProtocol [class]
    module.add_class('RoutingProtocol', parent=root_module['ns3::Ipv4RoutingProtocol'])
    ## raodv-rtable.h (module 'raodv'): ns3::raodv::RoutingTable [class]
    module.add_class('RoutingTable')
    ## raodv-rtable.h (module 'raodv'): ns3::raodv::RoutingTableEntry [class]
    module.add_class('RoutingTableEntry')
    ## raodv-packet.h (module 'raodv'): ns3::raodv::RrepAckHeader [class]
    module.add_class('RrepAckHeader', parent=root_module['ns3::Header'])
    ## raodv-packet.h (module 'raodv'): ns3::raodv::RrepHeader [class]
    module.add_class('RrepHeader', parent=root_module['ns3::Header'])
    ## raodv-packet.h (module 'raodv'): ns3::raodv::RreqHeader [class]
    module.add_class('RreqHeader', parent=root_module['ns3::Header'])
    ## raodv-packet.h (module 'raodv'): ns3::raodv::TypeHeader [class]
...
def register_methods(root_module):
    ...
    register_Ns3RaodvHelper_methods(root_module, root_module['ns3::RaodvHelper'])
    ...
    register_Ns3RaodvDuplicatePacketDetection_methods(root_module, root_module['ns3::raodv::DuplicatePacketDetection'])
    register_Ns3RaodvIdCache_methods(root_module, root_module['ns3::raodv::IdCache'])
    register_Ns3RaodvNeighbors_methods(root_module, root_module['ns3::raodv::Neighbors'])
    register_Ns3RaodvNeighborsNeighbor_methods(root_module, root_module['ns3::raodv::Neighbors::Neighbor'])
    register_Ns3RaodvQueueEntry_methods(root_module, root_module['ns3::raodv::QueueEntry'])
    register_Ns3RaodvRequestQueue_methods(root_module, root_module['ns3::raodv::RequestQueue'])
    register_Ns3RaodvRerrHeader_methods(root_module, root_module['ns3::raodv::RerrHeader'])
    register_Ns3RaodvRoutingProtocol_methods(root_module, root_module['ns3::raodv::RoutingProtocol'])
    register_Ns3RaodvRoutingTable_methods(root_module, root_module['ns3::raodv::RoutingTable'])
    register_Ns3RaodvRoutingTableEntry_methods(root_module, root_module['ns3::raodv::RoutingTableEntry'])
    register_Ns3RaodvRrepAckHeader_methods(root_module, root_module['ns3::raodv::RrepAckHeader'])
    register_Ns3RaodvRrepHeader_methods(root_module, root_module['ns3::raodv::RrepHeader'])
    register_Ns3RaodvRreqHeader_methods(root_module, root_module['ns3::raodv::RreqHeader'])
    register_Ns3RaodvTypeHeader_methods(root_module, root_module['ns3::raodv::TypeHeader'])
    return
...
def register_Ns3RaodvHelper_methods(root_module, cls):
    ## raodv-helper.h (module 'raodv'): ns3::RaodvHelper::RaodvHelper(ns3::RaodvHelper const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::RaodvHelper const &', 'arg0')])
    ## raodv-helper.h (module 'raodv'): ns3::RaodvHelper::RaodvHelper() [constructor]
    cls.add_constructor([])
    ## raodv-helper.h (module 'raodv'): int64_t ns3::RaodvHelper::AssignStreams(ns3::NodeContainer c, int64_t stream) [member function]
    cls.add_method('AssignStreams', 
                   'int64_t', 
                   [param('ns3::NodeContainer', 'c'), param('int64_t', 'stream')])
    ## raodv-helper.h (module 'raodv'): ns3::RaodvHelper * ns3::RaodvHelper::Copy() const [member function]
    cls.add_method('Copy', 
                   'ns3::RaodvHelper *', 
                   [], 
                   is_const=True, is_virtual=True)
    ## raodv-helper.h (module 'raodv'): ns3::Ptr<ns3::Ipv4RoutingProtocol> ns3::RaodvHelper::Create(ns3::Ptr<ns3::Node> node) const [member function]
    cls.add_method('Create', 
                   'ns3::Ptr< ns3::Ipv4RoutingProtocol >', 
                   [param('ns3::Ptr< ns3::Node >', 'node')], 
                   is_const=True, is_virtual=True)
    ## raodv-helper.h (module 'raodv'): void ns3::RaodvHelper::Set(std::string name, ns3::AttributeValue const & value) [member function]
    cls.add_method('Set', 
                   'void', 
                   [param('std::string', 'name'), param('ns3::AttributeValue const &', 'value')])
    return
...
def register_Ns3RaodvDuplicatePacketDetection_methods(root_module, cls):
    ## raodv-dpd.h (module 'raodv'): ns3::raodv::DuplicatePacketDetection::DuplicatePacketDetection(ns3::raodv::DuplicatePacketDetection const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::raodv::DuplicatePacketDetection const &', 'arg0')])
    ## raodv-dpd.h (module 'raodv'): ns3::raodv::DuplicatePacketDetection::DuplicatePacketDetection(ns3::Time lifetime) [constructor]
    cls.add_constructor([param('ns3::Time', 'lifetime')])
    ## raodv-dpd.h (module 'raodv'): ns3::Time ns3::raodv::DuplicatePacketDetection::GetLifetime() const [member function]
    cls.add_method('GetLifetime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## raodv-dpd.h (module 'raodv'): bool ns3::raodv::DuplicatePacketDetection::IsDuplicate(ns3::Ptr<ns3::Packet const> p, ns3::Ipv4Header const & header) [member function]
    cls.add_method('IsDuplicate', 
                   'bool', 
                   [param('ns3::Ptr< ns3::Packet const >', 'p'), param('ns3::Ipv4Header const &', 'header')])
    ## raodv-dpd.h (module 'raodv'): void ns3::raodv::DuplicatePacketDetection::SetLifetime(ns3::Time lifetime) [member function]
    cls.add_method('SetLifetime', 
                   'void', 
                   [param('ns3::Time', 'lifetime')])
    return

def register_Ns3RaodvIdCache_methods(root_module, cls):
    ## raodv-id-cache.h (module 'raodv'): ns3::raodv::IdCache::IdCache(ns3::raodv::IdCache const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::raodv::IdCache const &', 'arg0')])
    ## raodv-id-cache.h (module 'raodv'): ns3::raodv::IdCache::IdCache(ns3::Time lifetime) [constructor]
    cls.add_constructor([param('ns3::Time', 'lifetime')])
    ## raodv-id-cache.h (module 'raodv'): ns3::Time ns3::raodv::IdCache::GetLifeTime() const [member function]
    cls.add_method('GetLifeTime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## raodv-id-cache.h (module 'raodv'): uint32_t ns3::raodv::IdCache::GetSize() [member function]
    cls.add_method('GetSize', 
                   'uint32_t', 
                   [])
    ## raodv-id-cache.h (module 'raodv'): bool ns3::raodv::IdCache::IsDuplicate(ns3::Ipv4Address addr, uint32_t id) [member function]
    cls.add_method('IsDuplicate', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'addr'), param('uint32_t', 'id')])
    ## raodv-id-cache.h (module 'raodv'): void ns3::raodv::IdCache::Purge() [member function]
    cls.add_method('Purge', 
                   'void', 
                   [])
    ## raodv-id-cache.h (module 'raodv'): void ns3::raodv::IdCache::SetLifetime(ns3::Time lifetime) [member function]
    cls.add_method('SetLifetime', 
                   'void', 
                   [param('ns3::Time', 'lifetime')])
    return

def register_Ns3RaodvNeighbors_methods(root_module, cls):
    ## raodv-neighbor.h (module 'raodv'): ns3::raodv::Neighbors::Neighbors(ns3::raodv::Neighbors const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::raodv::Neighbors const &', 'arg0')])
    ## raodv-neighbor.h (module 'raodv'): ns3::raodv::Neighbors::Neighbors(ns3::Time delay) [constructor]
    cls.add_constructor([param('ns3::Time', 'delay')])
    ## raodv-neighbor.h (module 'raodv'): void ns3::raodv::Neighbors::AddArpCache(ns3::Ptr<ns3::ArpCache> arg0) [member function]
    cls.add_method('AddArpCache', 
                   'void', 
                   [param('ns3::Ptr< ns3::ArpCache >', 'arg0')])
    ## raodv-neighbor.h (module 'raodv'): void ns3::raodv::Neighbors::Clear() [member function]
    cls.add_method('Clear', 
                   'void', 
                   [])
    ## raodv-neighbor.h (module 'raodv'): void ns3::raodv::Neighbors::DelArpCache(ns3::Ptr<ns3::ArpCache> arg0) [member function]
    cls.add_method('DelArpCache', 
                   'void', 
                   [param('ns3::Ptr< ns3::ArpCache >', 'arg0')])
    ## raodv-neighbor.h (module 'raodv'): ns3::Callback<void, ns3::Ipv4Address, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> ns3::raodv::Neighbors::GetCallback() const [member function]
    cls.add_method('GetCallback', 
                   ...
                   [], 
                   is_const=True)
    ## raodv-neighbor.h (module 'raodv'): ns3::Time ns3::raodv::Neighbors::GetExpireTime(ns3::Ipv4Address addr) [member function]
    cls.add_method('GetExpireTime', 
                   'ns3::Time', 
                   [param('ns3::Ipv4Address', 'addr')])
    ## raodv-neighbor.h (module 'raodv'): ns3::Callback<void, ns3::WifiMacHeader const&, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> ns3::raodv::Neighbors::GetTxErrorCallback() const [member function]
    cls.add_method('GetTxErrorCallback', 
                   ...
                   [], 
                   is_const=True)
    ## raodv-neighbor.h (module 'raodv'): bool ns3::raodv::Neighbors::IsNeighbor(ns3::Ipv4Address addr) [member function]
    cls.add_method('IsNeighbor', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'addr')])
    ## raodv-neighbor.h (module 'raodv'): void ns3::raodv::Neighbors::Purge() [member function]
    cls.add_method('Purge', 
                   'void', 
                   [])
    ## raodv-neighbor.h (module 'raodv'): void ns3::raodv::Neighbors::ScheduleTimer() [member function]
    cls.add_method('ScheduleTimer', 
                   'void', 
                   [])
    ## raodv-neighbor.h (module 'raodv'): void ns3::raodv::Neighbors::SetCallback(ns3::Callback<void, ns3::Ipv4Address, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> cb) [member function]
    ...
    ## raodv-neighbor.h (module 'raodv'): void ns3::raodv::Neighbors::Update(ns3::Ipv4Address addr, ns3::Time expire) [member function]
    cls.add_method('Update', 
                   'void', 
                   [param('ns3::Ipv4Address', 'addr'), param('ns3::Time', 'expire')])
    return

def register_Ns3RaodvNeighborsNeighbor_methods(root_module, cls):
    ## raodv-neighbor.h (module 'raodv'): ns3::raodv::Neighbors::Neighbor::Neighbor(ns3::raodv::Neighbors::Neighbor const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::raodv::Neighbors::Neighbor const &', 'arg0')])
    ## raodv-neighbor.h (module 'raodv'): ns3::raodv::Neighbors::Neighbor::Neighbor(ns3::Ipv4Address ip, ns3::Mac48Address mac, ns3::Time t) [constructor]
    cls.add_constructor([param('ns3::Ipv4Address', 'ip'), param('ns3::Mac48Address', 'mac'), param('ns3::Time', 't')])
    ## raodv-neighbor.h (module 'raodv'): ns3::raodv::Neighbors::Neighbor::close [variable]
    cls.add_instance_attribute('close', 'bool', is_const=False)
    ## raodv-neighbor.h (module 'raodv'): ns3::raodv::Neighbors::Neighbor::m_expireTime [variable]
    cls.add_instance_attribute('m_expireTime', 'ns3::Time', is_const=False)
    ## raodv-neighbor.h (module 'raodv'): ns3::raodv::Neighbors::Neighbor::m_hardwareAddress [variable]
    cls.add_instance_attribute('m_hardwareAddress', 'ns3::Mac48Address', is_const=False)
    ## raodv-neighbor.h (module 'raodv'): ns3::raodv::Neighbors::Neighbor::m_neighborAddress [variable]
    cls.add_instance_attribute('m_neighborAddress', 'ns3::Ipv4Address', is_const=False)
    return

def register_Ns3RaodvQueueEntry_methods(root_module, cls):
    cls.add_binary_comparison_operator('==')
    ## raodv-rqueue.h (module 'raodv'): ns3::raodv::QueueEntry::QueueEntry(ns3::raodv::QueueEntry const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::raodv::QueueEntry const &', 'arg0')])
    ## raodv-rqueue.h (module 'raodv'): ns3::raodv::QueueEntry::QueueEntry(ns3::Ptr<ns3::Packet const> pa=0, ns3::Ipv4Header const & h=ns3::Ipv4Header(), ns3::Callback<void, ns3::Ptr<ns3::Ipv4Route>, ns3::Ptr<ns3::Packet const>, ns3::Ipv4Header const&, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> ucb=ns3::Callback<void, ns3::Ptr<ns3::Ipv4Route>, ns3::Ptr<const ns3::Packet>, const ns3::Ipv4Header&, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty>(), ns3::Callback<void, ns3::Ptr<ns3::Packet const>, ns3::Ipv4Header const&, ns3::Socket::SocketErrno, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> ecb=ns3::Callback<void, ns3::Ptr<const ns3::Packet>, const ns3::Ipv4Header&, ns3::Socket::SocketErrno, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty>(), ns3::Time exp=ns3::Simulator::Now( )) [constructor]
    ...
    ## raodv-rqueue.h (module 'raodv'): ns3::Callback<void, ns3::Ptr<ns3::Packet const>, ns3::Ipv4Header const&, ns3::Socket::SocketErrno, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> ns3::raodv::QueueEntry::GetErrorCallback() const [member function]
    cls.add_method('GetErrorCallback', 
                   ...
                   [], 
                   is_const=True)
    ## raodv-rqueue.h (module 'raodv'): ns3::Time ns3::raodv::QueueEntry::GetExpireTime() const [member function]
    cls.add_method('GetExpireTime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## raodv-rqueue.h (module 'raodv'): ns3::Ipv4Header ns3::raodv::QueueEntry::GetIpv4Header() const [member function]
    cls.add_method('GetIpv4Header', 
                   'ns3::Ipv4Header', 
                   [], 
                   is_const=True)
    ## raodv-rqueue.h (module 'raodv'): ns3::Ptr<ns3::Packet const> ns3::raodv::QueueEntry::GetPacket() const [member function]
    cls.add_method('GetPacket', 
                   'ns3::Ptr< ns3::Packet const >', 
                   [], 
                   is_const=True)
    ## raodv-rqueue.h (module 'raodv'): ns3::Callback<void, ns3::Ptr<ns3::Ipv4Route>, ns3::Ptr<ns3::Packet const>, ns3::Ipv4Header const&, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> ns3::raodv::QueueEntry::GetUnicastForwardCallback() const [member function]
    cls.add_method('GetUnicastForwardCallback', 
                   ...
                   [], 
                   is_const=True)
    ## raodv-rqueue.h (module 'raodv'): void ns3::raodv::QueueEntry::SetErrorCallback(ns3::Callback<void, ns3::Ptr<ns3::Packet const>, ns3::Ipv4Header const&, ns3::Socket::SocketErrno, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> ecb) [member function]
    ...
    ## raodv-rqueue.h (module 'raodv'): void ns3::raodv::QueueEntry::SetExpireTime(ns3::Time exp) [member function]
    cls.add_method('SetExpireTime', 
                   'void', 
                   [param('ns3::Time', 'exp')])
    ## raodv-rqueue.h (module 'raodv'): void ns3::raodv::QueueEntry::SetIpv4Header(ns3::Ipv4Header h) [member function]
    cls.add_method('SetIpv4Header', 
                   'void', 
                   [param('ns3::Ipv4Header', 'h')])
    ## raodv-rqueue.h (module 'raodv'): void ns3::raodv::QueueEntry::SetPacket(ns3::Ptr<ns3::Packet const> p) [member function]
    cls.add_method('SetPacket', 
                   'void', 
                   [param('ns3::Ptr< ns3::Packet const >', 'p')])
    ## raodv-rqueue.h (module 'raodv'): void ns3::raodv::QueueEntry::SetUnicastForwardCallback(ns3::Callback<void, ns3::Ptr<ns3::Ipv4Route>, ns3::Ptr<ns3::Packet const>, ns3::Ipv4Header const&, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> ucb) [member function]
...
def register_Ns3RaodvRequestQueue_methods(root_module, cls):
    ## raodv-rqueue.h (module 'raodv'): ns3::raodv::RequestQueue::RequestQueue(ns3::raodv::RequestQueue const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::raodv::RequestQueue const &', 'arg0')])
    ## raodv-rqueue.h (module 'raodv'): ns3::raodv::RequestQueue::RequestQueue(uint32_t maxLen, ns3::Time routeToQueueTimeout) [constructor]
    cls.add_constructor([param('uint32_t', 'maxLen'), param('ns3::Time', 'routeToQueueTimeout')])
    ## raodv-rqueue.h (module 'raodv'): bool ns3::raodv::RequestQueue::Dequeue(ns3::Ipv4Address dst, ns3::raodv::QueueEntry & entry) [member function]
    cls.add_method('Dequeue', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst'), param('ns3::raodv::QueueEntry &', 'entry')])
    ## raodv-rqueue.h (module 'raodv'): void ns3::raodv::RequestQueue::DropPacketWithDst(ns3::Ipv4Address dst) [member function]
    cls.add_method('DropPacketWithDst', 
                   'void', 
                   [param('ns3::Ipv4Address', 'dst')])
    ## raodv-rqueue.h (module 'raodv'): bool ns3::raodv::RequestQueue::Enqueue(ns3::raodv::QueueEntry & entry) [member function]
    cls.add_method('Enqueue', 
                   'bool', 
                   [param('ns3::raodv::QueueEntry &', 'entry')])
    ## raodv-rqueue.h (module 'raodv'): bool ns3::raodv::RequestQueue::Find(ns3::Ipv4Address dst) [member function]
    cls.add_method('Find', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst')])
    ## raodv-rqueue.h (module 'raodv'): uint32_t ns3::raodv::RequestQueue::GetMaxQueueLen() const [member function]
    cls.add_method('GetMaxQueueLen', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## raodv-rqueue.h (module 'raodv'): ns3::Time ns3::raodv::RequestQueue::GetQueueTimeout() const [member function]
    cls.add_method('GetQueueTimeout', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## raodv-rqueue.h (module 'raodv'): uint32_t ns3::raodv::RequestQueue::GetSize() [member function]
    cls.add_method('GetSize', 
                   'uint32_t', 
                   [])
    ## raodv-rqueue.h (module 'raodv'): void ns3::raodv::RequestQueue::SetMaxQueueLen(uint32_t len) [member function]
    cls.add_method('SetMaxQueueLen', 
                   'void', 
                   [param('uint32_t', 'len')])
    ## raodv-rqueue.h (module 'raodv'): void ns3::raodv::RequestQueue::SetQueueTimeout(ns3::Time t) [member function]
    cls.add_method('SetQueueTimeout', 
                   'void', 
                   [param('ns3::Time', 't')])
    return

def register_Ns3RaodvRerrHeader_methods(root_module, cls):
    cls.add_output_stream_operator()
    cls.add_binary_comparison_operator('==')
    ## raodv-packet.h (module 'raodv'): ns3::raodv::RerrHeader::RerrHeader(ns3::raodv::RerrHeader const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::raodv::RerrHeader const &', 'arg0')])
    ## raodv-packet.h (module 'raodv'): ns3::raodv::RerrHeader::RerrHeader() [constructor]
    cls.add_constructor([])
    ## raodv-packet.h (module 'raodv'): bool ns3::raodv::RerrHeader::AddUnDestination(ns3::Ipv4Address dst, uint32_t seqNo) [member function]
    cls.add_method('AddUnDestination', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst'), param('uint32_t', 'seqNo')])
    ## raodv-packet.h (module 'raodv'): void ns3::raodv::RerrHeader::Clear() [member function]
    cls.add_method('Clear', 
                   'void', 
                   [])
    ## raodv-packet.h (module 'raodv'): uint32_t ns3::raodv::RerrHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## raodv-packet.h (module 'raodv'): uint8_t ns3::raodv::RerrHeader::GetDestCount() const [member function]
    cls.add_method('GetDestCount', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## raodv-packet.h (module 'raodv'): ns3::TypeId ns3::raodv::RerrHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## raodv-packet.h (module 'raodv'): bool ns3::raodv::RerrHeader::GetNoDelete() const [member function]
    cls.add_method('GetNoDelete', 
                   'bool', 
                   [], 
                   is_const=True)
    ## raodv-packet.h (module 'raodv'): uint32_t ns3::raodv::RerrHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## raodv-packet.h (module 'raodv'): static ns3::TypeId ns3::raodv::RerrHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## raodv-packet.h (module 'raodv'): void ns3::raodv::RerrHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## raodv-packet.h (module 'raodv'): bool ns3::raodv::RerrHeader::RemoveUnDestination(std::pair<ns3::Ipv4Address,unsigned int> & un) [member function]
    cls.add_method('RemoveUnDestination', 
                   'bool', 
                   [param('std::pair< ns3::Ipv4Address, unsigned int > &', 'un')])
    ## raodv-packet.h (module 'raodv'): void ns3::raodv::RerrHeader::Serialize(ns3::Buffer::Iterator i) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'i')], 
                   is_const=True, is_virtual=True)
    ## raodv-packet.h (module 'raodv'): void ns3::raodv::RerrHeader::SetNoDelete(bool f) [member function]
    cls.add_method('SetNoDelete', 
                   'void', 
                   [param('bool', 'f')])
    return

def register_Ns3RaodvRoutingProtocol_methods(root_module, cls):
    ## raodv-routing-protocol.h (module 'raodv'): ns3::raodv::RoutingProtocol::RoutingProtocol(ns3::raodv::RoutingProtocol const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::raodv::RoutingProtocol const &', 'arg0')])
    ## raodv-routing-protocol.h (module 'raodv'): ns3::raodv::RoutingProtocol::RoutingProtocol() [constructor]
    cls.add_constructor([])
    ## raodv-routing-protocol.h (module 'raodv'): int64_t ns3::raodv::RoutingProtocol::AssignStreams(int64_t stream) [member function]
    cls.add_method('AssignStreams', 
                   'int64_t', 
                   [param('int64_t', 'stream')])
    ## raodv-routing-protocol.h (module 'raodv'): void ns3::raodv::RoutingProtocol::DoDispose() [member function]
    cls.add_method('DoDispose', 
                   'void', 
                   [], 
                   is_virtual=True)
    ## raodv-routing-protocol.h (module 'raodv'): bool ns3::raodv::RoutingProtocol::GetBroadcastEnable() const [member function]
    cls.add_method('GetBroadcastEnable', 
                   'bool', 
                   [], 
                   is_const=True)
    ## raodv-routing-protocol.h (module 'raodv'): bool ns3::raodv::RoutingProtocol::GetDesinationOnlyFlag() const [member function]
    cls.add_method('GetDesinationOnlyFlag', 
                   'bool', 
                   [], 
                   is_const=True)
    ## raodv-routing-protocol.h (module 'raodv'): bool ns3::raodv::RoutingProtocol::GetGratuitousReplyFlag() const [member function]
    cls.add_method('GetGratuitousReplyFlag', 
                   'bool', 
                   [], 
                   is_const=True)
    ## raodv-routing-protocol.h (module 'raodv'): bool ns3::raodv::RoutingProtocol::GetHelloEnable() const [member function]
    cls.add_method('GetHelloEnable', 
                   'bool', 
                   [], 
                   is_const=True)
    ## raodv-routing-protocol.h (module 'raodv'): uint32_t ns3::raodv::RoutingProtocol::GetMaxQueueLen() const [member function]
    cls.add_method('GetMaxQueueLen', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## raodv-routing-protocol.h (module 'raodv'): ns3::Time ns3::raodv::RoutingProtocol::GetMaxQueueTime() const [member function]
    cls.add_method('GetMaxQueueTime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## raodv-routing-protocol.h (module 'raodv'): static ns3::TypeId ns3::raodv::RoutingProtocol::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## raodv-routing-protocol.h (module 'raodv'): void ns3::raodv::RoutingProtocol::NotifyAddAddress(uint32_t interface, ns3::Ipv4InterfaceAddress address) [member function]
    cls.add_method('NotifyAddAddress', 
                   'void', 
                   [param('uint32_t', 'interface'), param('ns3::Ipv4InterfaceAddress', 'address')], 
                   is_virtual=True)
    ## raodv-routing-protocol.h (module 'raodv'): void ns3::raodv::RoutingProtocol::NotifyInterfaceDown(uint32_t interface) [member function]
    cls.add_method('NotifyInterfaceDown', 
                   'void', 
                   [param('uint32_t', 'interface')], 
                   is_virtual=True)
    ## raodv-routing-protocol.h (module 'raodv'): void ns3::raodv::RoutingProtocol::NotifyInterfaceUp(uint32_t interface) [member function]
    cls.add_method('NotifyInterfaceUp', 
                   'void', 
                   [param('uint32_t', 'interface')], 
                   is_virtual=True)
    ## raodv-routing-protocol.h (module 'raodv'): void ns3::raodv::RoutingProtocol::NotifyRemoveAddress(uint32_t interface, ns3::Ipv4InterfaceAddress address) [member function]
    cls.add_method('NotifyRemoveAddress', 
                   'void', 
                   [param('uint32_t', 'interface'), param('ns3::Ipv4InterfaceAddress', 'address')], 
                   is_virtual=True)
    ## raodv-routing-protocol.h (module 'raodv'): void ns3::raodv::RoutingProtocol::PrintRoutingTable(ns3::Ptr<ns3::OutputStreamWrapper> stream) const [member function]
    cls.add_method('PrintRoutingTable', 
                   'void', 
                   [param('ns3::Ptr< ns3::OutputStreamWrapper >', 'stream')], 
                   is_const=True, is_virtual=True)
    ## raodv-routing-protocol.h (module 'raodv'): bool ns3::raodv::RoutingProtocol::RouteInput(ns3::Ptr<ns3::Packet const> p, ns3::Ipv4Header const & header, ns3::Ptr<const ns3::NetDevice> idev, ns3::Callback<void, ns3::Ptr<ns3::Ipv4Route>, ns3::Ptr<ns3::Packet const>, ns3::Ipv4Header const&, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> ucb, ns3::Callback<void,ns3::Ptr<ns3::Ipv4MulticastRoute>,ns3::Ptr<const ns3::Packet>,const ns3::Ipv4Header&,ns3::empty,ns3::empty,ns3::empty,ns3::empty,ns3::empty,ns3::empty> mcb, ns3::Callback<void,ns3::Ptr<const ns3::Packet>,const ns3::Ipv4Header&,unsigned int,ns3::empty,ns3::empty,ns3::empty,ns3::empty,ns3::empty,ns3::empty> lcb, ns3::Callback<void, ns3::Ptr<ns3::Packet const>, ns3::Ipv4Header const&, ns3::Socket::SocketErrno, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> ecb) [member function]
    cls.add_method('RouteInput', 
                   'bool', 
                   [param('ns3::Ptr< ns3::Packet const >', 'p'), param('ns3::Ipv4Header const &', 'header'), param('ns3::Ptr< ns3::NetDevice const >', 'idev'), param('ns3::Callback< void, ns3::Ptr< ns3::Ipv4Route >, ns3::Ptr< ns3::Packet const >, ns3::Ipv4Header const &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'ucb'), param('ns3::Callback< void, ns3::Ptr< ns3::Ipv4MulticastRoute >, ns3::Ptr< ns3::Packet const >, ns3::Ipv4Header const &, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'mcb'), param('ns3::Callback< void, ns3::Ptr< ns3::Packet const >, ns3::Ipv4Header const &, unsigned int, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'lcb'), param('ns3::Callback< void, ns3::Ptr< ns3::Packet const >, ns3::Ipv4Header const &, ns3::Socket::SocketErrno, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'ecb')], 
                   is_virtual=True)
    ## raodv-routing-protocol.h (module 'raodv'): ns3::Ptr<ns3::Ipv4Route> ns3::raodv::RoutingProtocol::RouteOutput(ns3::Ptr<ns3::Packet> p, ns3::Ipv4Header const & header, ns3::Ptr<ns3::NetDevice> oif, ns3::Socket::SocketErrno & sockerr) [member function]
    cls.add_method('RouteOutput', 
                   'ns3::Ptr< ns3::Ipv4Route >', 
                   [param('ns3::Ptr< ns3::Packet >', 'p'), param('ns3::Ipv4Header const &', 'header'), param('ns3::Ptr< ns3::NetDevice >', 'oif'), param('ns3::Socket::SocketErrno &', 'sockerr')], 
                   is_virtual=True)
    ## raodv-routing-protocol.h (module 'raodv'): void ns3::raodv::RoutingProtocol::SetBroadcastEnable(bool f) [member function]
    cls.add_method('SetBroadcastEnable', 
                   'void', 
                   [param('bool', 'f')])
    ## raodv-routing-protocol.h (module 'raodv'): void ns3::raodv::RoutingProtocol::SetDesinationOnlyFlag(bool f) [member function]
    cls.add_method('SetDesinationOnlyFlag', 
                   'void', 
                   [param('bool', 'f')])
    ## raodv-routing-protocol.h (module 'raodv'): void ns3::raodv::RoutingProtocol::SetGratuitousReplyFlag(bool f) [member function]
    cls.add_method('SetGratuitousReplyFlag', 
                   'void', 
                   [param('bool', 'f')])
    ## raodv-routing-protocol.h (module 'raodv'): void ns3::raodv::RoutingProtocol::SetHelloEnable(bool f) [member function]
    cls.add_method('SetHelloEnable', 
                   'void', 
                   [param('bool', 'f')])
    ## raodv-routing-protocol.h (module 'raodv'): void ns3::raodv::RoutingProtocol::SetIpv4(ns3::Ptr<ns3::Ipv4> ipv4) [member function]
    cls.add_method('SetIpv4', 
                   'void', 
                   [param('ns3::Ptr< ns3::Ipv4 >', 'ipv4')], 
                   is_virtual=True)
    ## raodv-routing-protocol.h (module 'raodv'): void ns3::raodv::RoutingProtocol::SetMaxQueueLen(uint32_t len) [member function]
    cls.add_method('SetMaxQueueLen', 
                   'void', 
                   [param('uint32_t', 'len')])
    ## raodv-routing-protocol.h (module 'raodv'): void ns3::raodv::RoutingProtocol::SetMaxQueueTime(ns3::Time t) [member function]
    cls.add_method('SetMaxQueueTime', 
                   'void', 
                   [param('ns3::Time', 't')])
    ## raodv-routing-protocol.h (module 'raodv'): ns3::raodv::RoutingProtocol::RAODV_PORT [variable]
    cls.add_static_attribute('RAODV_PORT', 'uint32_t const', is_const=True)
    return

def register_Ns3RaodvRoutingTable_methods(root_module, cls):
    ## raodv-rtable.h (module 'raodv'): ns3::raodv::RoutingTable::RoutingTable(ns3::raodv::RoutingTable const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::raodv::RoutingTable const &', 'arg0')])
    ## raodv-rtable.h (module 'raodv'): ns3::raodv::RoutingTable::RoutingTable(ns3::Time t) [constructor]
    cls.add_constructor([param('ns3::Time', 't')])
    ## raodv-rtable.h (module 'raodv'): bool ns3::raodv::RoutingTable::AddRoute(ns3::raodv::RoutingTableEntry & r) [member function]
    cls.add_method('AddRoute', 
                   'bool', 
                   [param('ns3::raodv::RoutingTableEntry &', 'r')])
    ## raodv-rtable.h (module 'raodv'): void ns3::raodv::RoutingTable::Clear() [member function]
    cls.add_method('Clear', 
                   'void', 
                   [])
    ## raodv-rtable.h (module 'raodv'): void ns3::raodv::RoutingTable::DeleteAllRoutesFromInterface(ns3::Ipv4InterfaceAddress iface) [member function]
    cls.add_method('DeleteAllRoutesFromInterface', 
                   'void', 
                   [param('ns3::Ipv4InterfaceAddress', 'iface')])
    ## raodv-rtable.h (module 'raodv'): bool ns3::raodv::RoutingTable::DeleteRoute(ns3::Ipv4Address dst) [member function]
    cls.add_method('DeleteRoute', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst')])
    ## raodv-rtable.h (module 'raodv'): ns3::Time ns3::raodv::RoutingTable::GetBadLinkLifetime() const [member function]
    cls.add_method('GetBadLinkLifetime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## raodv-rtable.h (module 'raodv'): void ns3::raodv::RoutingTable::GetListOfDestinationWithNextHop(ns3::Ipv4Address nextHop, std::map<ns3::Ipv4Address, unsigned int, std::less<ns3::Ipv4Address>, std::allocator<std::pair<ns3::Ipv4Address const, unsigned int> > > & unreachable) [member function]
    ...
    ## raodv-rtable.h (module 'raodv'): void ns3::raodv::RoutingTable::InvalidateRoutesWithDst(std::map<ns3::Ipv4Address, unsigned int, std::less<ns3::Ipv4Address>, std::allocator<std::pair<ns3::Ipv4Address const, unsigned int> > > const & unreachable) [member function]
    cls.add_method('InvalidateRoutesWithDst', 
                   'void', 
                   [param('std::map< ns3::Ipv4Address, unsigned int > const &', 'unreachable')])
    ## raodv-rtable.h (module 'raodv'): bool ns3::raodv::RoutingTable::LookupRoute(ns3::Ipv4Address dst, ns3::raodv::RoutingTableEntry & rt) [member function]
    cls.add_method('LookupRoute', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst'), param('ns3::raodv::RoutingTableEntry &', 'rt')])
    ## raodv-rtable.h (module 'raodv'): bool ns3::raodv::RoutingTable::LookupValidRoute(ns3::Ipv4Address dst, ns3::raodv::RoutingTableEntry & rt) [member function]
    cls.add_method('LookupValidRoute', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst'), param('ns3::raodv::RoutingTableEntry &', 'rt')])
    ## raodv-rtable.h (module 'raodv'): bool ns3::raodv::RoutingTable::MarkLinkAsUnidirectional(ns3::Ipv4Address neighbor, ns3::Time blacklistTimeout) [member function]
    cls.add_method('MarkLinkAsUnidirectional', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'neighbor'), param('ns3::Time', 'blacklistTimeout')])
    ## raodv-rtable.h (module 'raodv'): void ns3::raodv::RoutingTable::Print(ns3::Ptr<ns3::OutputStreamWrapper> stream) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('ns3::Ptr< ns3::OutputStreamWrapper >', 'stream')], 
                   is_const=True)
    ## raodv-rtable.h (module 'raodv'): void ns3::raodv::RoutingTable::Purge() [member function]
    cls.add_method('Purge', 
                   'void', 
                   [])
    ## raodv-rtable.h (module 'raodv'): void ns3::raodv::RoutingTable::SetBadLinkLifetime(ns3::Time t) [member function]
    cls.add_method('SetBadLinkLifetime', 
                   'void', 
                   [param('ns3::Time', 't')])
    ## raodv-rtable.h (module 'raodv'): bool ns3::raodv::RoutingTable::SetEntryState(ns3::Ipv4Address dst, ns3::raodv::RouteFlags state) [member function]
    cls.add_method('SetEntryState', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'dst'), param('ns3::raodv::RouteFlags', 'state')])
    ## raodv-rtable.h (module 'raodv'): bool ns3::raodv::RoutingTable::Update(ns3::raodv::RoutingTableEntry & rt) [member function]
    cls.add_method('Update', 
                   'bool', 
                   [param('ns3::raodv::RoutingTableEntry &', 'rt')])
    return

def register_Ns3RaodvRoutingTableEntry_methods(root_module, cls):
    ## raodv-rtable.h (module 'raodv'): ns3::raodv::RoutingTableEntry::RoutingTableEntry(ns3::raodv::RoutingTableEntry const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::raodv::RoutingTableEntry const &', 'arg0')])
    ## raodv-rtable.h (module 'raodv'): ns3::raodv::RoutingTableEntry::RoutingTableEntry(ns3::Ptr<ns3::NetDevice> dev=0, ns3::Ipv4Address dst=ns3::Ipv4Address(), bool vSeqNo=false, uint32_t m_seqNo=0, ns3::Ipv4InterfaceAddress iface=ns3::Ipv4InterfaceAddress(), uint16_t hops=0, ns3::Ipv4Address nextHop=ns3::Ipv4Address(), ns3::Time lifetime=ns3::Simulator::Now( )) [constructor]
    ...
    ## raodv-rtable.h (module 'raodv'): void ns3::raodv::RoutingTableEntry::DeleteAllPrecursors() [member function]
    cls.add_method('DeleteAllPrecursors', 
                   'void', 
                   [])
    ## raodv-rtable.h (module 'raodv'): bool ns3::raodv::RoutingTableEntry::DeletePrecursor(ns3::Ipv4Address id) [member function]
    cls.add_method('DeletePrecursor', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'id')])
    ## raodv-rtable.h (module 'raodv'): ns3::Time ns3::raodv::RoutingTableEntry::GetBlacklistTimeout() const [member function]
    cls.add_method('GetBlacklistTimeout', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## raodv-rtable.h (module 'raodv'): ns3::Ipv4Address ns3::raodv::RoutingTableEntry::GetDestination() const [member function]
    cls.add_method('GetDestination', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## raodv-rtable.h (module 'raodv'): ns3::raodv::RouteFlags ns3::raodv::RoutingTableEntry::GetFlag() const [member function]
    cls.add_method('GetFlag', 
                   'ns3::raodv::RouteFlags', 
                   [], 
                   is_const=True)
    ## raodv-rtable.h (module 'raodv'): uint16_t ns3::raodv::RoutingTableEntry::GetHop() const [member function]
    cls.add_method('GetHop', 
                   'uint16_t', 
                   [], 
                   is_const=True)
    ## raodv-rtable.h (module 'raodv'): ns3::Ipv4InterfaceAddress ns3::raodv::RoutingTableEntry::GetInterface() const [member function]
    cls.add_method('GetInterface', 
                   'ns3::Ipv4InterfaceAddress', 
                   [], 
                   is_const=True)
    ## raodv-rtable.h (module 'raodv'): ns3::Time ns3::raodv::RoutingTableEntry::GetLifeTime() const [member function]
    cls.add_method('GetLifeTime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## raodv-rtable.h (module 'raodv'): ns3::Ipv4Address ns3::raodv::RoutingTableEntry::GetNextHop() const [member function]
    cls.add_method('GetNextHop', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## raodv-rtable.h (module 'raodv'): ns3::Ptr<ns3::NetDevice> ns3::raodv::RoutingTableEntry::GetOutputDevice() const [member function]
    cls.add_method('GetOutputDevice', 
                   'ns3::Ptr< ns3::NetDevice >', 
                   [], 
                   is_const=True)
    ## raodv-rtable.h (module 'raodv'): void ns3::raodv::RoutingTableEntry::GetPrecursors(std::vector<ns3::Ipv4Address, std::allocator<ns3::Ipv4Address> > & prec) const [member function]
    cls.add_method('GetPrecursors', 
                   'void', 
                   [param('std::vector< ns3::Ipv4Address > &', 'prec')], 
                   is_const=True)
    ## raodv-rtable.h (module 'raodv'): ns3::Ptr<ns3::Ipv4Route> ns3::raodv::RoutingTableEntry::GetRoute() const [member function]
    cls.add_method('GetRoute', 
                   'ns3::Ptr< ns3::Ipv4Route >', 
                   [], 
                   is_const=True)
    ## raodv-rtable.h (module 'raodv'): uint8_t ns3::raodv::RoutingTableEntry::GetRreqCnt() const [member function]
    cls.add_method('GetRreqCnt', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## raodv-rtable.h (module 'raodv'): uint32_t ns3::raodv::RoutingTableEntry::GetSeqNo() const [member function]
    cls.add_method('GetSeqNo', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## raodv-rtable.h (module 'raodv'): bool ns3::raodv::RoutingTableEntry::GetValidSeqNo() const [member function]
    cls.add_method('GetValidSeqNo', 
                   'bool', 
                   [], 
                   is_const=True)
    ## raodv-rtable.h (module 'raodv'): void ns3::raodv::RoutingTableEntry::IncrementRreqCnt() [member function]
    cls.add_method('IncrementRreqCnt', 
                   'void', 
                   [])
    ## raodv-rtable.h (module 'raodv'): bool ns3::raodv::RoutingTableEntry::InsertPrecursor(ns3::Ipv4Address id) [member function]
    cls.add_method('InsertPrecursor', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'id')])
    ## raodv-rtable.h (module 'raodv'): void ns3::raodv::RoutingTableEntry::Invalidate(ns3::Time badLinkLifetime) [member function]
    cls.add_method('Invalidate', 
                   'void', 
                   [param('ns3::Time', 'badLinkLifetime')])
    ## raodv-rtable.h (module 'raodv'): bool ns3::raodv::RoutingTableEntry::IsPrecursorListEmpty() const [member function]
    cls.add_method('IsPrecursorListEmpty', 
                   'bool', 
                   [], 
                   is_const=True)
    ## raodv-rtable.h (module 'raodv'): bool ns3::raodv::RoutingTableEntry::IsUnidirectional() const [member function]
    cls.add_method('IsUnidirectional', 
                   'bool', 
                   [], 
                   is_const=True)
    ## raodv-rtable.h (module 'raodv'): bool ns3::raodv::RoutingTableEntry::LookupPrecursor(ns3::Ipv4Address id) [member function]
    cls.add_method('LookupPrecursor', 
                   'bool', 
                   [param('ns3::Ipv4Address', 'id')])
    ## raodv-rtable.h (module 'raodv'): void ns3::raodv::RoutingTableEntry::Print(ns3::Ptr<ns3::OutputStreamWrapper> stream) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('ns3::Ptr< ns3::OutputStreamWrapper >', 'stream')], 
                   is_const=True)
    ## raodv-rtable.h (module 'raodv'): void ns3::raodv::RoutingTableEntry::SetBalcklistTimeout(ns3::Time t) [member function]
    cls.add_method('SetBalcklistTimeout', 
                   'void', 
                   [param('ns3::Time', 't')])
    ## raodv-rtable.h (module 'raodv'): void ns3::raodv::RoutingTableEntry::SetFlag(ns3::raodv::RouteFlags flag) [member function]
    cls.add_method('SetFlag', 
                   'void', 
                   [param('ns3::raodv::RouteFlags', 'flag')])
    ## raodv-rtable.h (module 'raodv'): void ns3::raodv::RoutingTableEntry::SetHop(uint16_t hop) [member function]
    cls.add_method('SetHop', 
                   'void', 
                   [param('uint16_t', 'hop')])
    ## raodv-rtable.h (module 'raodv'): void ns3::raodv::RoutingTableEntry::SetInterface(ns3::Ipv4InterfaceAddress iface) [member function]
    cls.add_method('SetInterface', 
                   'void', 
                   [param('ns3::Ipv4InterfaceAddress', 'iface')])
    ## raodv-rtable.h (module 'raodv'): void ns3::raodv::RoutingTableEntry::SetLifeTime(ns3::Time lt) [member function]
    cls.add_method('SetLifeTime', 
                   'void', 
                   [param('ns3::Time', 'lt')])
    ## raodv-rtable.h (module 'raodv'): void ns3::raodv::RoutingTableEntry::SetNextHop(ns3::Ipv4Address nextHop) [member function]
    cls.add_method('SetNextHop', 
                   'void', 
                   [param('ns3::Ipv4Address', 'nextHop')])
    ## raodv-rtable.h (module 'raodv'): void ns3::raodv::RoutingTableEntry::SetOutputDevice(ns3::Ptr<ns3::NetDevice> dev) [member function]
    cls.add_method('SetOutputDevice', 
                   'void', 
                   [param('ns3::Ptr< ns3::NetDevice >', 'dev')])
    ## raodv-rtable.h (module 'raodv'): void ns3::raodv::RoutingTableEntry::SetRoute(ns3::Ptr<ns3::Ipv4Route> r) [member function]
    cls.add_method('SetRoute', 
                   'void', 
                   [param('ns3::Ptr< ns3::Ipv4Route >', 'r')])
    ## raodv-rtable.h (module 'raodv'): void ns3::raodv::RoutingTableEntry::SetRreqCnt(uint8_t n) [member function]
    cls.add_method('SetRreqCnt', 
                   'void', 
                   [param('uint8_t', 'n')])
    ## raodv-rtable.h (module 'raodv'): void ns3::raodv::RoutingTableEntry::SetSeqNo(uint32_t sn) [member function]
    cls.add_method('SetSeqNo', 
                   'void', 
                   [param('uint32_t', 'sn')])
    ## raodv-rtable.h (module 'raodv'): void ns3::raodv::RoutingTableEntry::SetUnidirectional(bool u) [member function]
    cls.add_method('SetUnidirectional', 
                   'void', 
                   [param('bool', 'u')])
    ## raodv-rtable.h (module 'raodv'): void ns3::raodv::RoutingTableEntry::SetValidSeqNo(bool s) [member function]
    cls.add_method('SetValidSeqNo', 
                   'void', 
                   [param('bool', 's')])
    ## raodv-rtable.h (module 'raodv'): ns3::raodv::RoutingTableEntry::m_ackTimer [variable]
    cls.add_instance_attribute('m_ackTimer', 'ns3::Timer', is_const=False)
    return

def register_Ns3RaodvRrepAckHeader_methods(root_module, cls):
    cls.add_output_stream_operator()
    cls.add_binary_comparison_operator('==')
    ## raodv-packet.h (module 'raodv'): ns3::raodv::RrepAckHeader::RrepAckHeader(ns3::raodv::RrepAckHeader const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::raodv::RrepAckHeader const &', 'arg0')])
    ## raodv-packet.h (module 'raodv'): ns3::raodv::RrepAckHeader::RrepAckHeader() [constructor]
    cls.add_constructor([])
    ## raodv-packet.h (module 'raodv'): uint32_t ns3::raodv::RrepAckHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## raodv-packet.h (module 'raodv'): ns3::TypeId ns3::raodv::RrepAckHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## raodv-packet.h (module 'raodv'): uint32_t ns3::raodv::RrepAckHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## raodv-packet.h (module 'raodv'): static ns3::TypeId ns3::raodv::RrepAckHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## raodv-packet.h (module 'raodv'): void ns3::raodv::RrepAckHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## raodv-packet.h (module 'raodv'): void ns3::raodv::RrepAckHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
...
def register_Ns3RaodvRrepHeader_methods(root_module, cls):
    cls.add_output_stream_operator()
    cls.add_binary_comparison_operator('==')
    ## raodv-packet.h (module 'raodv'): ns3::raodv::RrepHeader::RrepHeader(ns3::raodv::RrepHeader const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::raodv::RrepHeader const &', 'arg0')])
    ## raodv-packet.h (module 'raodv'): ns3::raodv::RrepHeader::RrepHeader(uint8_t prefixSize=0, uint8_t hopCount=0, ns3::Ipv4Address dst=ns3::Ipv4Address(), uint32_t dstSeqNo=0, ns3::Ipv4Address origin=ns3::Ipv4Address(), ns3::Time lifetime=ns3::MilliSeconds( )) [constructor]
    ...
    ## raodv-packet.h (module 'raodv'): uint32_t ns3::raodv::RrepHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## raodv-packet.h (module 'raodv'): bool ns3::raodv::RrepHeader::GetAckRequired() const [member function]
    cls.add_method('GetAckRequired', 
                   'bool', 
                   [], 
                   is_const=True)
    ## raodv-packet.h (module 'raodv'): ns3::Ipv4Address ns3::raodv::RrepHeader::GetDst() const [member function]
    cls.add_method('GetDst', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## raodv-packet.h (module 'raodv'): uint32_t ns3::raodv::RrepHeader::GetDstSeqno() const [member function]
    cls.add_method('GetDstSeqno', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## raodv-packet.h (module 'raodv'): uint8_t ns3::raodv::RrepHeader::GetHopCount() const [member function]
    cls.add_method('GetHopCount', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## raodv-packet.h (module 'raodv'): ns3::TypeId ns3::raodv::RrepHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## raodv-packet.h (module 'raodv'): ns3::Time ns3::raodv::RrepHeader::GetLifeTime() const [member function]
    cls.add_method('GetLifeTime', 
                   'ns3::Time', 
                   [], 
                   is_const=True)
    ## raodv-packet.h (module 'raodv'): ns3::Ipv4Address ns3::raodv::RrepHeader::GetOrigin() const [member function]
    cls.add_method('GetOrigin', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## raodv-packet.h (module 'raodv'): uint8_t ns3::raodv::RrepHeader::GetPrefixSize() const [member function]
    cls.add_method('GetPrefixSize', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## raodv-packet.h (module 'raodv'): uint32_t ns3::raodv::RrepHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## raodv-packet.h (module 'raodv'): static ns3::TypeId ns3::raodv::RrepHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## raodv-packet.h (module 'raodv'): void ns3::raodv::RrepHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## raodv-packet.h (module 'raodv'): void ns3::raodv::RrepHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
    ## raodv-packet.h (module 'raodv'): void ns3::raodv::RrepHeader::SetAckRequired(bool f) [member function]
    cls.add_method('SetAckRequired', 
                   'void', 
                   [param('bool', 'f')])
    ## raodv-packet.h (module 'raodv'): void ns3::raodv::RrepHeader::SetDst(ns3::Ipv4Address a) [member function]
    cls.add_method('SetDst', 
                   'void', 
                   [param('ns3::Ipv4Address', 'a')])
    ## raodv-packet.h (module 'raodv'): void ns3::raodv::RrepHeader::SetDstSeqno(uint32_t s) [member function]
    cls.add_method('SetDstSeqno', 
                   'void', 
                   [param('uint32_t', 's')])
    ## raodv-packet.h (module 'raodv'): void ns3::raodv::RrepHeader::SetHello(ns3::Ipv4Address src, uint32_t srcSeqNo, ns3::Time lifetime) [member function]
    cls.add_method('SetHello', 
                   'void', 
                   [param('ns3::Ipv4Address', 'src'), param('uint32_t', 'srcSeqNo'), param('ns3::Time', 'lifetime')])
    ## raodv-packet.h (module 'raodv'): void ns3::raodv::RrepHeader::SetHopCount(uint8_t count) [member function]
    cls.add_method('SetHopCount', 
                   'void', 
                   [param('uint8_t', 'count')])
    ## raodv-packet.h (module 'raodv'): void ns3::raodv::RrepHeader::SetLifeTime(ns3::Time t) [member function]
    cls.add_method('SetLifeTime', 
                   'void', 
                   [param('ns3::Time', 't')])
    ## raodv-packet.h (module 'raodv'): void ns3::raodv::RrepHeader::SetOrigin(ns3::Ipv4Address a) [member function]
    cls.add_method('SetOrigin', 
                   'void', 
                   [param('ns3::Ipv4Address', 'a')])
    ## raodv-packet.h (module 'raodv'): void ns3::raodv::RrepHeader::SetPrefixSize(uint8_t sz) [member function]
    cls.add_method('SetPrefixSize', 
                   'void', 
                   [param('uint8_t', 'sz')])
    return

def register_Ns3RaodvRreqHeader_methods(root_module, cls):
    cls.add_output_stream_operator()
    cls.add_binary_comparison_operator('==')
    ## raodv-packet.h (module 'raodv'): ns3::raodv::RreqHeader::RreqHeader(ns3::raodv::RreqHeader const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::raodv::RreqHeader const &', 'arg0')])
    ## raodv-packet.h (module 'raodv'): ns3::raodv::RreqHeader::RreqHeader(uint8_t flags=0, uint8_t reserved=0, uint8_t hopCount=0, uint32_t requestID=0, ns3::Ipv4Address dst=ns3::Ipv4Address(), uint32_t dstSeqNo=0, ns3::Ipv4Address origin=ns3::Ipv4Address(), uint32_t originSeqNo=0) [constructor]
    ...
    ## raodv-packet.h (module 'raodv'): uint32_t ns3::raodv::RreqHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## raodv-packet.h (module 'raodv'): bool ns3::raodv::RreqHeader::GetDestinationOnly() const [member function]
    cls.add_method('GetDestinationOnly', 
                   'bool', 
                   [], 
                   is_const=True)
    ## raodv-packet.h (module 'raodv'): ns3::Ipv4Address ns3::raodv::RreqHeader::GetDst() const [member function]
    cls.add_method('GetDst', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## raodv-packet.h (module 'raodv'): uint32_t ns3::raodv::RreqHeader::GetDstSeqno() const [member function]
    cls.add_method('GetDstSeqno', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## raodv-packet.h (module 'raodv'): bool ns3::raodv::RreqHeader::GetGratiousRrep() const [member function]
    cls.add_method('GetGratiousRrep', 
                   'bool', 
                   [], 
                   is_const=True)
    ## raodv-packet.h (module 'raodv'): uint8_t ns3::raodv::RreqHeader::GetHopCount() const [member function]
    cls.add_method('GetHopCount', 
                   'uint8_t', 
                   [], 
                   is_const=True)
    ## raodv-packet.h (module 'raodv'): uint32_t ns3::raodv::RreqHeader::GetId() const [member function]
    cls.add_method('GetId', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## raodv-packet.h (module 'raodv'): ns3::TypeId ns3::raodv::RreqHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## raodv-packet.h (module 'raodv'): ns3::Ipv4Address ns3::raodv::RreqHeader::GetOrigin() const [member function]
    cls.add_method('GetOrigin', 
                   'ns3::Ipv4Address', 
                   [], 
                   is_const=True)
    ## raodv-packet.h (module 'raodv'): uint32_t ns3::raodv::RreqHeader::GetOriginSeqno() const [member function]
    cls.add_method('GetOriginSeqno', 
                   'uint32_t', 
                   [], 
                   is_const=True)
    ## raodv-packet.h (module 'raodv'): uint32_t ns3::raodv::RreqHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## raodv-packet.h (module 'raodv'): static ns3::TypeId ns3::raodv::RreqHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## raodv-packet.h (module 'raodv'): bool ns3::raodv::RreqHeader::GetUnknownSeqno() const [member function]
    cls.add_method('GetUnknownSeqno', 
                   'bool', 
                   [], 
                   is_const=True)
    ## raodv-packet.h (module 'raodv'): void ns3::raodv::RreqHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## raodv-packet.h (module 'raodv'): void ns3::raodv::RreqHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
    ## raodv-packet.h (module 'raodv'): void ns3::raodv::RreqHeader::SetDestinationOnly(bool f) [member function]
    cls.add_method('SetDestinationOnly', 
                   'void', 
                   [param('bool', 'f')])
    ## raodv-packet.h (module 'raodv'): void ns3::raodv::RreqHeader::SetDst(ns3::Ipv4Address a) [member function]
    cls.add_method('SetDst', 
                   'void', 
                   [param('ns3::Ipv4Address', 'a')])
    ## raodv-packet.h (module 'raodv'): void ns3::raodv::RreqHeader::SetDstSeqno(uint32_t s) [member function]
    cls.add_method('SetDstSeqno', 
                   'void', 
                   [param('uint32_t', 's')])
    ## raodv-packet.h (module 'raodv'): void ns3::raodv::RreqHeader::SetGratiousRrep(bool f) [member function]
    cls.add_method('SetGratiousRrep', 
                   'void', 
                   [param('bool', 'f')])
    ## raodv-packet.h (module 'raodv'): void ns3::raodv::RreqHeader::SetHopCount(uint8_t count) [member function]
    cls.add_method('SetHopCount', 
                   'void', 
                   [param('uint8_t', 'count')])
    ## raodv-packet.h (module 'raodv'): void ns3::raodv::RreqHeader::SetId(uint32_t id) [member function]
    cls.add_method('SetId', 
                   'void', 
                   [param('uint32_t', 'id')])
    ## raodv-packet.h (module 'raodv'): void ns3::raodv::RreqHeader::SetOrigin(ns3::Ipv4Address a) [member function]
    cls.add_method('SetOrigin', 
                   'void', 
                   [param('ns3::Ipv4Address', 'a')])
    ## raodv-packet.h (module 'raodv'): void ns3::raodv::RreqHeader::SetOriginSeqno(uint32_t s) [member function]
    cls.add_method('SetOriginSeqno', 
                   'void', 
                   [param('uint32_t', 's')])
    ## raodv-packet.h (module 'raodv'): void ns3::raodv::RreqHeader::SetUnknownSeqno(bool f) [member function]
    cls.add_method('SetUnknownSeqno', 
                   'void', 
                   [param('bool', 'f')])
    return

def register_Ns3RaodvTypeHeader_methods(root_module, cls):
    cls.add_output_stream_operator()
    cls.add_binary_comparison_operator('==')
    ## raodv-packet.h (module 'raodv'): ns3::raodv::TypeHeader::TypeHeader(ns3::raodv::TypeHeader const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::raodv::TypeHeader const &', 'arg0')])
    ## raodv-packet.h (module 'raodv'): ns3::raodv::TypeHeader::TypeHeader(ns3::raodv::MessageType t=::ns3::raodv::RAODVTYPE_RREQ) [constructor]
    cls.add_constructor([param('ns3::raodv::MessageType', 't', default_value='::ns3::raodv::RAODVTYPE_RREQ')])
    ## raodv-packet.h (module 'raodv'): uint32_t ns3::raodv::TypeHeader::Deserialize(ns3::Buffer::Iterator start) [member function]
    cls.add_method('Deserialize', 
                   'uint32_t', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_virtual=True)
    ## raodv-packet.h (module 'raodv'): ns3::raodv::MessageType ns3::raodv::TypeHeader::Get() const [member function]
    cls.add_method('Get', 
                   'ns3::raodv::MessageType', 
                   [], 
                   is_const=True)
    ## raodv-packet.h (module 'raodv'): ns3::TypeId ns3::raodv::TypeHeader::GetInstanceTypeId() const [member function]
    cls.add_method('GetInstanceTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_const=True, is_virtual=True)
    ## raodv-packet.h (module 'raodv'): uint32_t ns3::raodv::TypeHeader::GetSerializedSize() const [member function]
    cls.add_method('GetSerializedSize', 
                   'uint32_t', 
                   [], 
                   is_const=True, is_virtual=True)
    ## raodv-packet.h (module 'raodv'): static ns3::TypeId ns3::raodv::TypeHeader::GetTypeId() [member function]
    cls.add_method('GetTypeId', 
                   'ns3::TypeId', 
                   [], 
                   is_static=True)
    ## raodv-packet.h (module 'raodv'): bool ns3::raodv::TypeHeader::IsValid() const [member function]
    cls.add_method('IsValid', 
                   'bool', 
                   [], 
                   is_const=True)
    ## raodv-packet.h (module 'raodv'): void ns3::raodv::TypeHeader::Print(std::ostream & os) const [member function]
    cls.add_method('Print', 
                   'void', 
                   [param('std::ostream &', 'os')], 
                   is_const=True, is_virtual=True)
    ## raodv-packet.h (module 'raodv'): void ns3::raodv::TypeHeader::Serialize(ns3::Buffer::Iterator start) const [member function]
    cls.add_method('Serialize', 
                   'void', 
                   [param('ns3::Buffer::Iterator', 'start')], 
                   is_const=True, is_virtual=True)
...
def register_functions(root_module):
    ...
    register_functions_ns3_raodv(module.get_submodule('raodv'), root_module)
    return
...
def register_functions_ns3_raodv(module, root_module):
    return
